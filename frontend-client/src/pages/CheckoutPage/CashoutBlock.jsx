  ...
  return (
    <div className={reuseableStyle.block}>
      ...
      <div className="grid grid-cols-[6fr_4fr] gap-2 text-[14px] font-medium">
        ...
        <span className="justify-self-end">{formatMoney(299000)} VNĐ</span>
        <span>Giảm giá trực tiếp</span>
        <span className={'text-red-500' + ' justify-self-end'}>
          -{formatMoney(299000)} VNĐ
        </span>
        ...
        >
          Tiết kiệm {formatMoney(299000)} VNĐ
        </span>
      </div>
      <button className="button-standard-1 bg-[#da291c]! text-[14px]! font-bold! mt-4">
        THANH TOÁN
      </button>
    </div>
  );
