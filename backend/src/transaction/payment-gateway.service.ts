...
const config = {
  ...
  partnerCode: 'MOMO',
  redirectUrl: '', // link frontend, fe will send
  ipnUrl:
    'https://198d-2402-800-629d-a6e-7123-99ac-b012-6643.ngrok-free.app/api/payment/callback', //chú ý: cần dùng ngrok thì momo mới post đến url này được
